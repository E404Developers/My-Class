...
<form id="login" action="#" method="post">
	<img src="../src/icon.png"><h1>Student Registration</h1>
	<div class="items">
	<p><a href="teacherRegister.php">I'm a teacher</a></p>
    <input type="text" class="input" id="email" placeholder="User Name" name="uname">

   <input type="text" class="" id="password" placeholder="Enter your full name" name="fullname"><br><br>

   <input type="text" class="" id="password" placeholder="Enter your school/university/institute" name="school"><br><br>

   <label>Date Of Birth</label>	
   <input type="date" style="padding-left:10px;" class="" id="password" placeholder="" name="birthday"><br><br>

   <input type="email" class="" id="password" placeholder="Enter your email" name="email"><br><br>
